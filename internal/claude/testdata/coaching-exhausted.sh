...
for _attempt in 1 2 3; do
  if [ "$_attempt" -eq 3 ]; then
    echo '{"type":"assistant","message":{"content":[{"type":"text","text":"{\"watchtower_decision\": {\"question\": \"Q?\", \"options\": [\"a\",\"b\"], \"recommended\": 0}}"},{"type":"tool_use","name":"mcp__watchtower__workspace_read","input":{"file_path":"ISSUE.md"}}]}}'
  else
